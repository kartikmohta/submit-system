...
python ~/class-monitor/update_leaderboard.py ~/fall2011-projects/db/project_groups.db ~/fall2011-projects/db/leaderboard.db ~/fall2011-projects/db/answers.txt ~/submit/$project/$user > result.txt || exit 1
